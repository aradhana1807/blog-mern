...
export default function DashProfile() {
	...
	const [imageFileUploadErorr, setImageFileUploadErorr] = useState(null);
	...
	const uploadImage = async () => {
		...
		uploadTask.on(
			...
			, (error) => {
				setImageFileUploadErorr('Could not upload image (File must be less than 2MB)');
	...
	return (
		<div className='max-w-lg mx-auto p-3 w-full'>
			...
			<form className='flex flex-col gap-4'>
							...
							styles={
								{
									...
									path: {
										stroke: `rgba(17,106,123, {imageFileUploadProgress / 100})`
									}
								}
							}
						/>
				...
				{imageFileUploadErorr &&
					<Alert color="failure">{imageFileUploadErorr}
					</Alert>
				}
